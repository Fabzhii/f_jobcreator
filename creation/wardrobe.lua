...
function editThisOutfit(id, identifier)
            ...
            if v.identifier == identifier then 
                lib.registerContext({
                    ...
                    options = {
                        ...
                        {
                            title = Menus.CreatePoints.edit_outfits,
                            description = Menus.CreatePoints.edit_outfits_desc,
                            icon = 'pen-to-square',
                            onSelect = function()
                                setOutfits(id, identifier, v.id)
                            end,
                        },
                        {
